...
if item_shotgun_ammo == nil then
	item_shotgun_ammo = class({})
end

function item_shotgun_ammo:CastFilterResultTarget(hTarget)
	--print("Error")
	if IsServer() then
...
function item_shotgun_ammo:GetCustomCastErrorTarget(hTarget)
	--print("Error")
	if IsServer() then
...
function item_shotgun_ammo:OnSpellStart()
	--print("OnSpellStart")
